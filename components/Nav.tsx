...
const Links = (): JSX.Element => (
  <>
    ...
    <NavLink href="/blog/photos">Blog</NavLink>
...
const Nav = ({ isOpen, onOpen, onClose }: NavProps): JSX.Element => {
  ...
  return (
    <Grid
      ...
      margin="3rem 0"
    >
      <Container paddingLeft={30} display={['none', 'none', 'flex']}>
        <NavLink href="/">Austin Sehorn</NavLink>
      </Container>
      ...
      >
        <NavLink href="mailto:austinsehorn@gmail.com">Contact</NavLink>
      </Container>
    </Grid>
  );
};
